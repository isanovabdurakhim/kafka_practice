...
//@Accept json
//@Produce json
//@Param find query car24_car_service.GetAllModelsRequest false "filters"
//@Success 201 {object} car24_car_service.GetAllModelsResponse
//@Failure 400 {object} response.ResponseError
//@Failure 500 {object} response.ResponseError
func (h *handlerV1) GetAllModels(c *gin.Context) {
	var (
		queryParam car24_car_service.ModelQueryParam
		err        error
	)
