...
func NewModel(db *sqlx.DB) repo.Model {
	return &modelRepo{
		db: db,
	}
}

func (br *modelRepo) Create(model *cs.CreateModel) (string, error) {
	tsx, err := br.db.Begin()
	if err != nil {
		return "", err
	}
...
func (br *modelRepo) GetAll(queryParam cs.ModelQueryParam) (res cs.ModelList, err error) {
...
func (br *modelRepo) Update(model *cs.UpdateModel) (err error) {
