...
func NewBrand(db *sqlx.DB) repo.Brand {
	return &brandRepo{
		db: db,
	}
}

func (br *brandRepo) Create(brand *cs.CreateBrand) (string, error) {
	tsx, err := br.db.Begin()
	if err != nil {
		return "", err
	}
...
func (br *brandRepo) GetAll(queryParam cs.BrandQueryParamModel) (res cs.BrandList, err error) {
...
func (br *brandRepo) Update(brand *cs.UpdateBrand) (err error) {
