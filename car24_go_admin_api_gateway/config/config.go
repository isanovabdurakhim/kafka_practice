...
func Load() Config {
	...
	c.BrandServiceUrl = cast.ToString(getOrReturnDefault("BRAND_SERVICE_URL", "http://localhost:8005"))
	c.ModelServiceUrl = cast.ToString(getOrReturnDefault("MODEL_SERVICE_URL", "http://localhost:8006"))
