...
func New(cnf Config) *gin.Engine {
	...
	// Car endpoints
	r.POST("/v1/model", handlerV1.CreateModel)
	r.GET("/v1/model/:id", handlerV1.GetModel)
	r.GET("/v1/model", handlerV1.GetAllModels)
	r.PUT("/v1/model/:id", handlerV1.UpdateModel)
	r.DELETE("/v1/model/:id", handlerV1.DeleteModel)
