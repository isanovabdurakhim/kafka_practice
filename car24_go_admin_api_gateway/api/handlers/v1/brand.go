...
// @Param Brand body car24_car_service.CreateBrand true "brand"
...
func (h *handlerV1) CreateBrand(c *gin.Context) {
	var brand car24_car_service.CreateBrand
...
// @Success 200 {object} car24_car_service.Brand
// @Failure 400 {object} response.ResponseError
// @Failure 500 {object} response.ResponseError
...
// @Success 200 {object} car24_car_service.BrandList
// @Failure 400 {object} response.ResponseError
// @Failure 500 {object} response.ResponseError
...
// @Param Platform-Id header string true "platform-id" default(7d4a4c38-dd84-4902-b744-0488b80a4c01)
// @Param id path string true "id"
// @Param Brand body car24_car_service.UpdateBrand true "brand"
// @Success 201 {object} response.ResponseOK
// @Failure 400 {object} response.ResponseError
// @Failure 500 {object} response.ResponseError
func (h *handlerV1) UpdateBrand(c *gin.Context) {
	var (
		brand car24_car_service.UpdateBrand
	)
...
func (h *handlerV1) DeleteBrand(c *gin.Context) {
	var (
		request car24_car_service.DeleteBrand
	)
